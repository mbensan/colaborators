...
class ColaboratorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create colaborator" do
    assert_difference("Colaborator.count") do
      post colaborators_url, params: { colaborator: { address: @colaborator.address, email: @colaborator.email, name: @colaborator.name } }
    end
  ...
  test "should update colaborator" do
    patch colaborator_url(@colaborator), params: { colaborator: { address: @colaborator.address, email: @colaborator.email, name: @colaborator.name } }
